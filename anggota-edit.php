<div class="row">
    ...
    <div class="col-6">
        ...
        <form action="?page=anggota-edit-proses" method="POST">
            ...
            <div class="form-group mt-2">
                <label for="">tpt_lahir</label>
                <input value="<?php echo $row['tpt_lahir'] ?>" class="form-control" type="text" name="tpt_lahir" placeholder="Tempat Lahir">
            </div>
            <div class="form-group mt-2">
            ...
            <div class="form-group mt-2">
                ...
                <input value="<?php echo $row["tlp"]?>" class="form-control" type="text" name="tlp" placeholder="tlp">
            </div>
            <div class="form-group mt-2">
